...
func (r *runner) buildSealCmd() *cobra.Command {
	...
	sealCmd.SetHelpFunc(func(_ *cobra.Command, _ []string) {
		_, _ = fmt.Fprintln(r.stdout, sealHelp)
	})
...
func (r *runner) buildSealLsCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if hasHelpFlag(args) {
				_, _ = fmt.Fprintln(r.stdout, sealLsHelp)
				return nil
			}
...
func (r *runner) buildSealClaimCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if hasHelpFlag(args) {
				_, _ = fmt.Fprintln(r.stdout, sealClaimHelp)
				return nil
			}
...
func (r *runner) buildSealUnclaimCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if hasHelpFlag(args) {
				_, _ = fmt.Fprintln(r.stdout, sealUnclaimHelp)
				return nil
			}
...
func (r *runner) buildSealTestCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if hasHelpFlag(args) {
				_, _ = fmt.Fprintln(r.stdout, sealTestHelp)
				return nil
			}
...
func (r *runner) buildSealDoctorCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if hasHelpFlag(args) {
				_, _ = fmt.Fprintln(r.stdout, sealDoctorHelp)
				return nil
			}
